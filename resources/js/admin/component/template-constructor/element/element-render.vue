<template>
  <div class="element-render">
      <div class="element-render-actions">
          ...
          <span v-if="element.element.hasFillable" @click="actionClicked('edit')" class="action-ico"><icon-pen></icon-pen></span>
...
import elementComponent from "../../template/element-component.vue";
